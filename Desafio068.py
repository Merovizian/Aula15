...
while True:
    jogador = input("Escolha Par ou impar: ").strip().upper()[0]
    while jogador not in 'PI':
        jogador = input("\033[1;31mEscolha Invalida!\033[m\nEscolha Par ou impar: ").strip().upper()[0]
    if jogador == 'P':
    ...
    if resultado % 2 == 0:
        ...
        resultado = 'I'
    print(f"A soma {jogador_numero} e {computador_numero} = {soma} é PAR" if resultado == 'P' else f"A soma {jogador_numero} e {computador_numero} = {soma} é IMPAR")
